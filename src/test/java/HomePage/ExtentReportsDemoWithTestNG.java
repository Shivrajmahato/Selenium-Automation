...
public class ExtentReportsDemoWithTestNG {
	...
	@BeforeSuite
	public void setUp() {
		extentSparkReporter = new ExtentSparkReporter("extent.html");
	...
	public void beforeTest() {
		...
		System.setProperty("user.dir", "D:\\Program Files\\Google\\Chrome\\Application\\chromedri.exe");
		System.out.println("User Home Path: "+System.getProperty("user.dir"));
		//String projectPathString = System.getProperty("C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe");
...
//		driver.manage().window().maximize();
	...
	public void test1() throws InterruptedException, IOException {
		ExtentTest test = extent.createTest("BPM Test","Test iform");
		...
		driver.manage().window().maximize();
		 WebElement textElement = driver.findElement(By.id("oaloginform:userid"));
		    ...
		    while(itr.hasNext()) {
		    	...
		    	Thread.sleep(1000);
//		    	/* this one is the place for taking screenshorts for the form place*/
//		    	File screenshot = driver.findElement(By.xpath("/html/body/div[5]/div/div/div[2]")).getScreenshotAs(OutputType.FILE);
//		    	FileHandler.copy(Screenshot,new File(System.getProperty("user.dir")+"\\screenshot.png"));
		...
		test.pass("Total Pass BPM");
		
		//log(Status, detail)
		test.log(Status.INFO, "Starting Test case");
		
		//info(details)
		test.info("use of info details");
		
		//fail(details)
		Assert.fail("details",com.aventstack.extentreports.MediaEntityBuilder.createScreenCaptureFromPath("Screenshort.png").build());
//		File screenshort = driver.findElement(By.xpath("/html/body/div[5]/div/div/div[2]")).getScreenshotAs(OutputType.FILE);
//    	FileHandler.copy(screenshort,new File(System.getProperty("user.dir")+"\\screenshot.png"));
		//test with snap short
	...
	public void test2() {
		...
		//log(Status, detail)
		test.log(Status.INFO, "Still in progress");
		
		//info(details)
		test.info("Still in progress");
